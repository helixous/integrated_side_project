    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(blank=True, choices=[('main', '메인계정'), ('sub', '서브계정'), ('guest', '게스트계정')], max_length=20, null=True)),
                ('email', models.EmailField(blank=True, max_length=254, null=True, verbose_name='email address')),
                ('password', models.CharField(blank=True, max_length=128, null=True, verbose_name='password')),
                ('phone', models.CharField(blank=True, max_length=11, null=True, verbose_name='휴대전화번호')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            managers=[
                ('objects', account.models.CustomAdministrationManager()),
            ],
        ),
    ]
